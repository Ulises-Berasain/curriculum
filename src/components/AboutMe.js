        ...
        <div className="containter-ub-info" id="about-me">
            ...
            <div className="container-info">
                <p>Mi nombre es <strong>Ulises Berasain</strong>, naci el <strong>11 de Marzo de 1994</strong> y actualmente resido en <strong>Azul, Provincia de Buenos Aires, Argentina</strong>.<br/>
                    ...
                    Busco poder seguir creciendo en lo que es la industria IT para poder estar en constante desarrollo tanto como persona y profecionalmente.<br/> 
                    Siempre estoy estudiando y buscando aprender algo nuevo, estar al tanto de las nuevas tecnologias que van saliendo y si son necesarias poder aprenderlas y dominarlas.
                </p>
            </div>
        </div>
    );
